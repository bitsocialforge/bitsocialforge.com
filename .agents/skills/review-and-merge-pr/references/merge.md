...
Merge using the repository-supported method consistent with the request. Do not bundle branch deletion into the merge command unless cleanup is also intended.
