...
<!-- Generated from .agents/skills/impeccable/SKILL.md; run yarn ai-workflow:sync. -->
...
The company’s brand and content rules in `AGENTS.md` govern the site. Existing Ember colors, self-hosted fonts, logo, and factual claims remain authoritative over generic aesthetic suggestions. Verification follows `docs/agent-playbooks/verification.md`.
