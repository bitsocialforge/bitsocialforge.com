...
When a bug fix or substantive review correction exposes a preventable mistake, use [retro](../retro/SKILL.md) to identify worthwhile prevention. Keep review-only requests recommendation-only.
